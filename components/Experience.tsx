...
export const Experience = () => {
  ...
  return (
    <div className=" max-w-5xl mx-auto px-8">
      ...
      Analytics and Data Science professional with 9 years of experience driving strategic,
       data-driven decisions across industries—now combining this expertise with entrepreneurial leadership in building AI and LLM-powered chatbot solutions
      </p>
